...
require.resolve = function(path) {
  if (path.charAt(0) === 'https://themesdesign.in/') path = path.slice(1);
...
require.normalize = function(curr, path) {
  ...
  curr = curr.split('https://themesdesign.in/');
  path = path.split('https://themesdesign.in/');
  ...
  return curr.concat(segs).join('https://themesdesign.in/');
};
...
require.relative = function(parent) {
  ...
  localRequire.resolve = function(path) {
    ...
    // directory
    var segs = parent.split('https://themesdesign.in/');
    var i = lastIndexOf(segs, 'deps') + 1;
    if (!i) i = 0;
    path = segs.slice(0, i + 1).join('https://themesdesign.in/') + '/deps/' + path;
    return path;
  };

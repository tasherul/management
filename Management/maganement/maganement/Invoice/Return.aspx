<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Return.aspx.cs" Inherits="maganement.Invoice.Return" %>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="page-title-box">
                                    <div class="float-right">
                                        <div class="dropdown">
                                           <div class="d-print-none float-right"><a href="javascript:window.print()" class="btn btn-info text-light"><i class="fas fa-print"></i></a> 
                                               <a href="../Return/ReturnList" class="btn btn-danger text-light">Back</a>
                                    ...
                                    <h4 class="page-title text-center">Return</h4></div>
                            </div>
                        </div>
                        <!-- end page title end breadcrumb    justify-content-end justify-content-between -->
                        <div id="divAlign" runat="server">
                            <div id="divSize" runat="server">
                                <div class="card">
                                    <div class="card-body invoice">
                                        <div class="float-right">
                                            <h6>Return ID : # <strong><asp:Label ID="lblInvoice" runat="server"></asp:Label></strong></h6>
...
<%--                                            <h6 class="mb-0">Order ID: #<asp:Label ID="lblorderID" runat="server" ></asp:Label> </h6>--%>
                                        ...
                                        <div class=" float-left">
                                            <h4 class="mb-0 align-self-center">
                                                ...
                                                <%--<h6 class="mb-0">Memo: <asp:Label ID="lblMemo" runat="server" ></asp:Label> </h6>--%>
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <div class="float-right mt-4">
                                                    <address>
                                                        ...
                                                        <asp:Label ID="lblCustomarPhone" runat="server" ></asp:Label>
                                                    </address>
                                                    ...
                                                    <table class="table mt-4">
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                ...
                                                                <td><asp:Label ID="lblDiscription" runat="server"></asp:Label></td>
                                                                <td><asp:Label ID="lblReturnPrice" runat="server"></asp:Label></td>
                                        ...
                                        <div class="row" style="border-radius: 0px;">
                                            ...
                                            <div class="col-md-10">
                                                <%--<p class="text-right"><strong>Total: </strong> <asp:Label ID="lblTotal" runat="server"></asp:Label></p>--%>
<%--                                                <p class="text-right">Discout: <asp:Label ID="lblDiscount" runat="server"></asp:Label></p>
                                                ...
                                                <hr/>
                                                <h3 class="text-right mb-0">Return Amount: <asp:Label ID="lblTotal" runat="server"></asp:Label></h3>
                                            </div>
                                        </div>
                                        <!--end row-->
                                        <hr/>

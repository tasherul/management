<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="maganement.Invoice.Default" %>
                        ...
                        <div class="row">
                            <div class="col-sm-12">
                                <div class="page-title-box">
                                    ...
                                    <h4 class="page-title text-center">Invoice</h4></div>
                            </div>
                        </div>
                                ...
                                <div class="card">
                                    <div class="card-body invoice">
                                        ...
                                        <div class="row" style="border-radius: 0px;">
                                            ...
                                            <div class="col-md-3">
                                                <p class="text-right"><strong>Sub-total:</strong> <asp:Label ID="lblSubTotal" runat="server"></asp:Label></p>
                                                ...
                                                <hr/>
                                                <h4 class="text-right mb-0">Paid: <asp:Label ID="lblPaid" runat="server"></asp:Label></h4>
                                            </div>
                                        </div>
                                        <!--end row-->
                                        <hr/>

    ...
    public partial class Customer_Add : System.Web.UI.Page
    {
        ...
        protected void btnCreate_Click(object sender, EventArgs e)
        {
            if(txtName.Text!="" && txtMobileNumber.Text!="")
            {
                ...
                if(_Chk.BoolSecurityCheck(string.Format(@"insert into Customer (Name,Email,Mobile,Gender,Address,Details) Values('{0}','{1}','{2}','{3}','{4}','{5}' )",Name,Email,Mobile,ddlGender.SelectedValue.ToString(),Address,Details)))
                {
                    lblResult.Text = "<div class='alert alert-success'><span> Successfully Customer Added.</span></div> ";
                    txtAddress.Text = "";
                    txtDetails.Text = "";
                    txtEmail.Text = "";
        ...
        protected void btnUpdate_Click(object sender, EventArgs e)
        {
            ...
            {
                if(_Chk.BoolSecurityCheck(string.Format("update Customer set Name='{0}',Email='{1}',Mobile='{2}',Gender='{3}',Address='{4}',Details='{5}' where c_id={6}",
                ...
                {
                    lblResult.Text = "<div class='alert alert-success'><span> Successfully Customer Update.</span></div> ";
                    txtAddress.Text = "";
                    txtDetails.Text = "";
                    txtEmail.Text = "";
                    txtMobileNumber.Text = "";
